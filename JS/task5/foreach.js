...
function showFirstAndLast(arr) {
    //Your Code Herearr.
    let newArr = [];
    arr.forEach(value => { newArr.push(value.charAt(0) + value.charAt(value.length - 1)) });
    return newArr;
}
...
function vowelCount(str) {
    ...
    let ocounter = 0;
    let ucounter = 0;
    let result = { a: acounter, i: icounter, e: ecounter, o: ocounter, u: ucounter };
    str.split('').forEach(x => {
